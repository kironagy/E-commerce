...
<?php endif; ?>
        ...
        <?php endif; ?>
        <?php
        // Remove the empty key element from the navigation array
        $filteredNavigation = array_filter($navigation, function($key) {
            return $key !== "";
        }, ARRAY_FILTER_USE_KEY);
    ?>
            <ul class="fi-sidebar-nav-groups -mx-2 flex flex-col gap-y-7">
            <?php $__currentLoopData = $filteredNavigation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home2/crevelme/one-store.crevel-eg.com/vendor/filament/filament/src/../resources/views/components/sidebar/index.blade.php ENDPATH**/ ?>