                        ...
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0"><?php echo e(App\Models\User::all()->count()); ?></h5>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0"><?php echo e(App\Models\Product::all()->count()); ?></h5>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0"><?php echo e(App\Models\Design::all()->count()); ?></h5>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0"><?php echo e(App\Models\ClientsDesign::all()->count()); ?></h5>
                                    </div>
                        ...
                        <div class="card radius-10 overflow-hidden w-100">
                            <div class="card-body">
                                ...
                                <div class="chart-container6">
                                    <div class="piechart-legend">
                                        <h2 class="mb-1"><?php echo e(App\Models\Product::all()->count()); ?></h2>
                            ...
                            <ul class="list-group list-group-flush">
                                <li
                                    ...
                                    Men
                                    <span class="badge bg-tiffany rounded-pill"><?php echo e(App\Models\Category::where('categories_name', 'Men')->count()); ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Women
                                    <span class="badge bg-success rounded-pill"><?php echo e(App\Models\Category::where('categories_name', 'Women')->count()); ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Kids
                                    <span class="badge bg-warning rounded-pill"><?php echo e(App\Models\Category::where('categories_name', 'Kids')->count()); ?></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    UniSex
                                    <span class="badge bg-danger rounded-pill"><?php echo e(App\Models\Category::where('categories_name', 'unisex')->count()); ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<div class="row row-cols-1 row-cols-md-2 g-3 align-items-center">
    <div class="col-lg-7 col-xl-7 col-xxl-7">
        <div class="chart-container5">
            <div class="piechart-legend">
                <h2 class="mb-1"><?php echo e($totalCustomers); ?></h2>
                <h6 class="mb-0">Customers</h6>
            </div>
        ...
        <div class="">
            <div class="d-flex align-items-start gap-2 mb-3">
                ...
                <div>
                    ...
                    <p class="mb-0 h5"><?php echo e(number_format($currentCustomersPercentage, 2)); ?>%</p>
                </div>
            </div>
            <div class="d-flex align-items-start gap-2 mb-3">
                <div>
                ...
                <div>
                    ...
                    <p class="mb-0 h5"><?php echo e(number_format($newCustomersPercentage, 2)); ?>%</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="card radius-10 mb-0">
                                    <div class="card-body">
                                        ...
                                        <h4 class="my-3"><?php echo e(number_format($newCustomersPercentage, 2)); ?>%</h4>
                                        <div class="progress mt-1" style="height: 5px;">
...
<?php /**PATH /home2/crevelme/one-store.crevel-eg.com/resources/views/Dashboard.blade.php ENDPATH**/ ?>