...
<div id="design-name" class="fw-bold fs-5 text-capitalize mb-3"></div>
            ...
            <div>
                ...
                <div class=" svg-bar d-flex justify-content-center align-items-center  position-fixed bottom-0 "
                    style=" z-index: 3343434;">
                                                 ...
                                                 <?php $__currentLoopData = $desgines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desgine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="svg-item bg-light p-2 rounded-3 " data-content="content1"  data-name="<?php echo e($desgine->name); ?>">
                    <!-- SVG 1 -->
                    <?php
        ...
        <div id="svg-modal" class="modal">
            ...
            <form action="<?php echo e(route('upload.desgine')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            </form>
                ...
                print.addEventListener("click", () => {
                    if (currentSvg && imgElement.src) {
                        ...
                        html2canvas(captureElement).then(canvas => {
                            ...
                            form.method = 'POST';
                            form.action = '<?php echo e(route('upload.desgine')); ?>';
...
<?php /**PATH /home2/crevelme/one-store.crevel-eg.com/resources/views/design.blade.php ENDPATH**/ ?>