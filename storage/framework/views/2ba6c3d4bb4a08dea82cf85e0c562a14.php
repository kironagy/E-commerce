                        ...
                        <div class="col-lg-6">
                            <div class="sp-content">
                                ...
                                <div class="col-12  p-3 p-md-2 d-flex flex-column ">
                                    <!-- product_name -->
                                    <div class="hedding fs-3 text-center fw-semibold mb-4"><?php echo e($product->item_name); ?></div>
                                    <!-- end product_name -->
                                    <!-- description -->
                                                    ...
                                                    <div class="accordion-body d-flex flex-column">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="d-flex align-items-center mb-2 ">
                                                                <div>
                                                                    <img draggable="false" src="<?php echo e(asset('assets/images/waving.png')); ?>">
                                                                </div>
                                                                <div class=" ms-3">
                                                            ...
                                                            <div class="d-flex align-items-center mb-2 ">
                                                                <div>
                                                                    <img draggable="false" src="<?php echo e(asset('assets/images/dying.png')); ?>">
                                                                </div>
                                                                <div class=" ms-3">
                                                            ...
                                                            <div class="d-flex align-items-center mb-2 ">
                                                                <div>
                                                                    <img draggable="false" src="<?php echo e(asset('assets/images/manufact.png')); ?>">
                                                                </div>
                                                                <div class=" ms-3">
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="col-12  mb-3">
                                                            <li class="more_details">
                                                                Express Shipping Delivery in <?php echo e($product->from_shipping_days); ?>-<?php echo e($product->to_shipping_days); ?> working days
                                                            </li>
                                                            <li class="more_details">
                                    ...
                                    <div class="fw-bold fs-4 me-2"><?php echo e($product->item_price - $product->item_discount); ?><span class="fs-6"><?php echo e($currency); ?></span> </div>
                                </div>
                                ...
                                <div class="qty-btn_area">
                                    <ul>
                                        ...
                                        <li><a class="qty-wishlist_btn" href="<?php echo e(route('wishlist.save', ['product'=> $product->id])); ?>" data-bs-toggle="tooltip" title="Add To Wishlist"><i class="ion-android-favorite-outline"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="add-actions">
                                <ul>
                                    <li class="quick-view-btn" data-bs-toggle="modal"
                                        data-bs-target="#_modal_product_<?php echo e($item->id); ?>">
