...
<?php $__currentLoopData = App\Models\Website::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <style>
        .bg-1,
        .bg-2 {
            background-image: url("/allImages/<?php echo e($slider->img); ?>");
        }
        ...
        <div class="slider-area">
            ...
            <div class="kenne-element-carousel home-slider arrow-style"
                ...
                <?php $__currentLoopData = App\Models\Website::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="slide-item bg-1 animation-style-01">
                        ...
                        <div class="container" style="">
                            <div class="slide-content "
                                style="<?php echo e(LaravelLocalization::getCurrentLocale() == 'ar' ? 'position:abeslute; right:130px;@media(max-width:780px){position:abeslute; right:30px !important;}' : 'position:abeslute; left:130px'); ?>">
                    ...
                    <!--    <div class="slider-progress"></div>-->
                    <!--
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  <div class="container">-->
                    <!--        <div class="slide-content">-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-6 custom-xxs-col">
                        <div class="banner-item img-hover_effect">
                            <div class="banner-img " data-aos="zoom-in-up">
                                <a href="javascrip:void(0)">
                                    <img class="rounded-3" src=<?php echo e(asset('assets/images/slider/378x252AR2.png')); ?>
                    ...
                    <div class="col-md-4 col-6 custom-xxs-col">
                        <div class="banner-item img-hover_effect">
                            <div class="banner-img " data-aos="zoom-in-up">
                                <a href="javascrip:void(0)">
                                    <img class="rounded-3" src=<?php echo e(asset('assets/images/slider/unnamednew2.png')); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <h3 style="position: relative;top:-40px;"><?php echo e(__('message.New_product')); ?></h3>
                ...
                <div class="row" style="overflow-x: hidden !important;">
                    <div class="col-md-6">
                        <div class="banner-item img-hover_effect" data-aos="fade-right">
                            <div class="banner-img">
                                <a href="javascrip:void(0)">
                                    <img class="img-full rounded-3" src=<?php echo e(url("allImages/$banner->panner_one")); ?>
                    ...
                    <div class="col-md-6" data-aos="fade-left">
                        <div class="banner-item img-hover_effect">
                            <div class="banner-img">
                                <a href="javascrip:void(0)">
                                    <img class="img-full rounded-3" src=<?php echo e(asset("allImages/$banner->panner_two")); ?>
...
<?php /**PATH H:\KDEV\.git_2\resources\views/index.blade.php ENDPATH**/ ?>