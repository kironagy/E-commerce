                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = auth()->user()->favorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $favorite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="kenne-product_remove"><a href="<?php echo e(route('wishlist.destroy', ['id' => $favorite->favorite_id])); ?>">
                                                    <i class="fa fa-trash"
                                                    title="Remove"></i></a></td>
                                                <td class="kenne-product-thumbnail"><a href="javascript:void(0)"><img src="<?php echo e(asset('allImages/'.$favorite->product->cover[0])); ?>" alt="Kenne's Wishlist Thumbnail"></a>
                                                </td>
                                                <td class="kenne-product-name"><a href="javascript:void(0)"><?php echo e($favorite->product->item_name); ?></a>
                                                </td>
                                                <td class="kenne-product-price"><span class="amount"><?php echo e($currency); ?> <?php echo e($favorite->product->item_price); ?></span></td>
                                                <td class="kenne-product-stock-status"><span class="<?php echo e(($favorite->product->quantity == 7 ? 'stock' : ($favorite->product->quantity < 7 ? 'out-stock' : 'in-stock'))); ?>">
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
                                                ...
                                                <td class="kenne-product-price"><span class="amount"><?php echo e($currency); ?> 00</span></td>
...
<?php /**PATH C:\Users\Administrator\Desktop\newOne\resources\views/wishlist.blade.php ENDPATH**/ ?>