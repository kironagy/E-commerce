                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="sp-content">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="flush-headingOne">
                                                    <button class="accordion-button collapsed hedding" type="button"
                                                        ...
                                                        <?php echo e(__('message.PRODUCT_DETAILS')); ?> </button>
                                                </h2>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="flush-headingTwo">
                                                    <button class="accordion-button collapsed hedding" type="button"
                                                        ...
                                                        <?php echo e(__('message.TRACEABILITY')); ?>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="flush-headingThree">
                                                    <button class="accordion-button collapsed hedding" type="button"
                                                        ...
                                                        <?php echo e(__('message.SHIPPING')); ?>
                                ...
                                <div class="quantity">
                                    <label><?php echo e(__('message.Quantity')); ?></label>
                                ...
                                <div class="qty-btn_area">
                                    <ul>
                                        <li><a class="qty-cart_btn me-2"
                                                href="<?php echo e(route('cart.save', ['product'=>$product])); ?>"><?php echo e(__('message.AddToCart')); ?></a></li>
                                        <li><a class="qty-cart_btn" href="<?php echo e(route('cart.save', ['product'=>$product])); ?>"><?php echo e(__('message.BuyItNow')); ?></a>
                                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <h3><?php echo e(__('msg.More_products')); ?></h3>
                                                                ...
                                                                <div class="accordion-item">
                                                                    <h2 class="accordion-header"
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            <?php echo e(__('message.PRODUCT_DETAILS')); ?>
...
<?php /**PATH /home2/crevelme/one-store.crevel-eg.com/resources/views/single-product.blade.php ENDPATH**/ ?>