                        ...
                        <div class="card_aucation rounded-3 w-100">
                            <div class="content p-2">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img class="rounded-3 mt-3" src="/allImages/<?php echo e($auction->img); ?>" alt="">
                                </div>
                                <div class="d-flex justify-content-center mt-4 align-items-center text">
                                    <div class="d-flex flex-column me-3">
                                        <div class="fs-sm">Start bid</div>
                                        <div class="fw-simebold"><?php echo e($auction->startPrice); ?><?php echo e($currency); ?></div>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <div class="fs-sm">Auction ends in</div>
                                        <div class="fw-simebold countdown" data-end-time="<?php echo e($auction->TimeEnd); ?>"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
