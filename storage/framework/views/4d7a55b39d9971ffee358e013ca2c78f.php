                            ...
                            <div class="card_aucation rounded-3 w-100">
                                <div class="content p-2">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <img class="rounded-3 mt-3" style="width:300px; height:200px" src="/allImages/<?php echo e($auction->img); ?>"   data-bs-toggle="modal" data-bs-target="#exampleModalCenter<?php echo e($auction->id); ?>"alt="">
                                    </div>
                                    <div class="d-flex justify-content-center mt-4 align-items-center text">
                                        <div class="d-flex flex-column me-3">
                                            <div class="fs-sm">Start bid</div>
                                            <div class="fw-simebold"><?php echo e($auction->endPrice ? $auction->endPrice : $auction->startPrice); ?><?php echo e($currency); ?></div>
                                        </div>
                            ...
                            <main>
                                <div class="product-image" style="display: flex; justify-content: center;">
                                    <img style="width: 300px;"
                                        src="/allImages/<?php echo e($auction->img); ?>"
                                        alt="Rolex Watch">
                                </div>
                                <div class="auction-details">
                                    <div class="bid-info">
                                        <div class="highest-bid">
                                            ...
                                            <span><?php echo e($auction->endPrice ? $auction->endPrice : $auction->startPrice); ?> L.E</span>
                                        </div>
...
<?php /**PATH C:\Users\Administrator\Desktop\newOne\resources\views/auction.blade.php ENDPATH**/ ?>