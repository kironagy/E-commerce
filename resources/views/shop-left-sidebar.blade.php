                                ...
                                <div class="sidebar-categories_menu">
                                    <ul>
                                        ...
                                        @foreach ($categories as $category)
                                            <li class="has-sub"><a
                                                    href="javascript:void(0)">{{ $category->categories_name }}<i
                                                        class="ion-ios-plus-empty"></i></a>
                                                <ul>
                                                    @foreach ($category->subCategory as $item)
                                                        <li><a
                                                                href="{{ route('ShopLeft', ['id' => $item->id]) }}">{{ $item->subcategoriesName }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                        ...
                                        <div class="single-product">
                                                ...
                                                <div class="add-actions">
                                                    <ul>
                                                        <li class="quick-view-btn" data-bs-toggle="modal"
                                                            data-bs-target="#exampleModalCenter{{ $item->id }}"><a
                                            ...
                                            <div class="product-content">
                                                <div class="product-desc_info">
                                                    ...
                                                    <div class="price-box">
                                                        <span
                                                            class="new-price">{{ $item->item_price }}{{ $currency }}</span>
                                                    </div>
