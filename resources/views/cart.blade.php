                                    ...
                                    @forelse (auth()->user()->carts as $cart)
                                        <tr>
                                            ...
                                            <td class="kenne-product-name">
                                                <a
                                                    href="{{ route('single-product', ['product' => $cart->product]) }}">{{ $cart->product->item_name }}</a>
                                            </td>
                                            <td class="kenne-product-price">
                                                <span class="amount">{{ $currency }}
                                                    {{ $cart->product->item_price }}</span>
                                            </td>
                                            <td class="quantity">
                                                <label>Quantity</label>
                                                <form class="formIncrease cart-plus-minus "
                                                    action="{{ route('UpdateCart') }}" method="POST">
                                                    @csrf
                                                    <div class="cart-plus-minus">
                                                        <input class="cart-plus-minus-box"
                                                            value="{{ $cart->basket_quantity }}" name="quantity"
                                                            type="text">
                                                        <input name="cart_item_id" type="hidden"
                                                            value="{{ $cart->basket_id }}">
                                            ...
                                            <td class="product-subtotal">
                                                <span class="amount">{{ $currency }}
                                                    {{ $cart->product->item_price * $cart->basket_quantity }}</span>
                                            </td>
                                        </tr>
                                    @empty
