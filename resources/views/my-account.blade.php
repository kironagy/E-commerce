                            ...
                            <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                                <div class="tab-pane fade show active" id="account-dashboard" role="tabpanel"
                                    ...
                                    <div class="myaccount-dashboard">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold"> {{ auth()->user()->user_Referralcode }} </div>
                                        </div>
                                                    ...
                                                    @foreach ($orders as $order)
                                                        <tr>
                                                            <td><a class="account-order-id"
                                                                    href="javascript:void(0)">#{{ $order->id }}</a>
                                                            </td>
                                ...
                                <div class="tab-pane fade" id="account-details" role="tabpanel"
                                    ...
                                    <div class="myaccount-details">
                                        <form method="POST" action="{{ route('editProfile') }}" class="kenne-form">
                                            @csrf
                                            <div class="kenne-form-inner">
                                                <div class="single-input single-input-half">
                                                    <label for="account-details-firstname"> Name*</label>
                                                    <input value="{{ auth()->user()->user_name }}" name="user_name"
                                                        type="text" id="account-details-firstname">
                                                </div>
                                                <div class="single-input">
                                                    <label for="account-details-email">Email*</label>
                                                    <input value="{{ auth()->user()->user_email }}" name="email"
