                            ...
                            <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                                ...
                                <div class="tab-pane fade" id="account-details" role="tabpanel" aria-labelledby="account-details-tab">
                                    <div class="myaccount-details">
                                        <form method="POST" action="{{ route("editProfile") }}" class="kenne-form">@csrf
                                            <div class="kenne-form-inner">
                                                <div class="single-input single-input-half">
                                                    <label for="account-details-firstname"> Name*</label>
                                                    <input value="{{ auth()->user()->user_name }}" name="user_name" type="text" id="account-details-firstname">
                                                </div>
                                                <div class="single-input">
                                                    <label for="account-details-email">Email*</label>
                                                    <input value="{{ auth()->user()->user_email }}" name="email" type="email" id="account-details-email">
                                                </div>
                                                <div class="single-input">
