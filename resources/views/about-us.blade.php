        ...
        <header class="main-header_area">
                        ...
                        <ul class="minicart-list">
                            <li class="minicart-product">
                                ...
                                <div class="product-item_img">
                                    <img src={{asset('assets/images/product/1-1.jpg')}} alt="Kenne's Product Image">
                                </div>
                            ...
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                        class="ion-android-close"></i></a>
                                <div class="product-item_img">
                                    <img src={{asset('assets/images/product/2-1.jpg')}} alt="Kenne's Product Image">
                                </div>
                                <div class="product-item_content">
                            ...
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                        class="ion-android-close"></i></a>
                                <div class="product-item_img">
                                    <img src={{asset('assets/images/product/3-1.jpg')}} alt="Kenne's Product Image">
                                </div>
                                <div class="product-item_content">
            ...
            <div class="offcanvas-menu_wrapper" id="offcanvasMenu">
                <div class="offcanvas-menu-inner">
                    ...
                    <div class="offcanvas-inner_logo">
                        <a href="shop-left-sidebar.html">
                            <img src={{asset('assets/images/logo.png')}} style="width: 100px;" alt="Munoz's Offcanvas Logo">
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-5">
                        <div class="overview-img text-center img-hover_effect">
                            <a href="#">
                                <img class="img-full" src={{asset('assets/images/about-us/1.jpg')}}
                    ...
                    <div class="col-lg-6 col-md-7 d-flex align-items-center">
                        <div class="overview-content">
                            ...
                            <p class="short_desc">We Provide Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                ...
                                quisquam.
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem, nulla veniam? Magni
                                aliquid
                                asperiores magnam. Veniam ex tenetur.</p>
                            <div class="kenne-about-us_btn-area">
                                <a class="about-us_btn" href="{{ route('ShopLeft') }}">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member">
                            <div class="team-thumb img-hover_effect">
                                <a href="#">
                                    <img src={{asset('assets/images/about-us/team/1.jpg')}} alt="Our Team Member">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member">
                            <div class="team-thumb img-hover_effect">
                                <a href="#">
                                    <img src={{asset('assets/images/about-us/team/2.jpg')}} alt="Our Team Member">
                                </a>
                            </div>
                            <div class="team-content text-center">
                                <h3>Anny Adams</h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member">
                            <div class="team-thumb img-hover_effect">
                                <a href="#">
                                    <img src={{asset('assets/images/about-us/team/3.jpg')}} alt="Our Team Member">
                                </a>
                            </div>
                            <div class="team-content text-center">
                                <h3>Edvin Adams</h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member">
                            <div class="team-thumb img-hover_effect">
                                <a href="#">
                                    <img src={{asset('assets/images/about-us/team/4.jpg')}} alt="Our Team Member">
                                </a>
                            </div>
                            <div class="team-content text-center">
                                <h3>Eddy Adams</h3>
            ...
            <div class="footer-bottom_area">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="payment">
                                <img src={{asset('assets/images/footer/payment/1.png')}} alt="Kenne's Payment Method">
                            </div>
                        </div>
                    </div>
                </div>
