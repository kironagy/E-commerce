...
<head>
    ...
    <!--Theme Styles-->
    <link href="{{ asset('assets2/css/dark-theme.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets2/css/semi-dark.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets2/css/header-colors.css') }}" rel="stylesheet" />
...
<body>
    ...
    <div class="wrapper">
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="{{ asset('assets2/images/logo-icon-2.png') }}" class="logo-icon" alt="logo icon">
                </div>
                <div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="/admin/websites/create">
                                <ion-icon name="ellipse-outline"></ion-icon>
                                website slider
                            </a>
                        </li>
                        <li><a href="/admin/panners/create">
                                <ion-icon name="ellipse-outline"></ion-icon>website panners
                            </a>
                        </li>
                        <li><a href="/admin/website-settings/create">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="/admin/designs/create">
                                <ion-icon name="ellipse-outline"></ion-icon>
                                workshop
                            </a>
                        </li>
                        ...
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0">{{ App\Models\User::all()->count() }}</h5>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0">{{ App\Models\Product::all()->count() }}</h5>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0">{{ App\Models\Design::all()->count() }}</h5>
                                    </div>
                        ...
                        <div class="card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <p class="mb-0">Clients Designs</p>
                                    </div>
                                    <div class="fs-5 ms-auto">
                                        <ion-icon name="ellipsis-horizontal-sharp"></ion-icon>
                                    </div>
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <div>
                                        <h5 class="mb-0">{{ App\Models\ClientsDesign::all()->count() }}</h5>
                                    </div>
                        ...
                        <div class="card radius-10 overflow-hidden w-100">
                            <div class="card-body">
                                ...
                                <div class="chart-container6">
                                    <div class="piechart-legend">
                                        <h2 class="mb-1">{{ App\Models\Product::all()->count() }}</h2>
                                        <h6 class="mb-0">Total items Categories</h6>
                                    </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li
                                    ...
                                    Men
                                    <span class="badge bg-tiffany rounded-pill">{{ App\Models\Category::where('categories_name', 'Men')->count() }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Women
                                    <span class="badge bg-success rounded-pill">{{ App\Models\Category::where('categories_name', 'Women')->count() }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Kids
                                    <span class="badge bg-warning rounded-pill">{{ App\Models\Category::where('categories_name', 'Kids')->count() }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    UniSex
                                    <span class="badge bg-danger rounded-pill">{{ App\Models\Category::where('categories_name', 'unisex')->count() }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    // Calculate the new and current customers
    $newCustomers = $users->filter(function($user) use ($now) {
        return $user->user_CreateTime >= $now->subDays(3);
    });

    $currentCustomers = $users->filter(function($user) use ($now) {
        return $user->user_CreateTime < $now->subDays(3);
    });

    // Calculate the percentages
    $newCustomersPercentage = ($totalCustomers > 0) ? ($newCustomers->count() / $totalCustomers) * 100 : 0;
    $currentCustomersPercentage = ($totalCustomers > 0) ? ($currentCustomers->count() / $totalCustomers) * 100 : 0;
@endphp
...
<div class="row row-cols-1 row-cols-md-2 g-3 align-items-center">
    <div class="col-lg-7 col-xl-7 col-xxl-7">
        <div class="chart-container5">
            <div class="piechart-legend">
                <h2 class="mb-1">{{ $totalCustomers }}</h2>
                <h6 class="mb-0">Customers</h6>
            </div>
        ...
        <div class="">
            <div class="d-flex align-items-start gap-2 mb-3">
                ...
                <div>
                    ...
                    <p class="mb-0 h5">{{ number_format($currentCustomersPercentage, 2) }}%</p>
                </div>
            </div>
            <div class="d-flex align-items-start gap-2 mb-3">
                <div>
                ...
                <div>
                    ...
                    <p class="mb-0 h5">{{ number_format($newCustomersPercentage, 2) }}%</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="card radius-10 mb-0">
                                    <div class="card-body">
                                        ...
                                        <h4 class="my-3">{{ number_format($newCustomersPercentage, 2) }}%</h4>
                                        <div class="progress mt-1" style="height: 5px;">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box border">
                                                    <img src="{{ asset('assets2/images/products/11.png') }}"
                                                        alt="">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box border">
                                                    <img src="{{ asset('assets2/images/products/07.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="product-info">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box border">
                                                    <img src="{{ asset('assets2/images/products/17.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="product-info">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box border">
                                                    <img src="{{ asset('assets2/images/products/04.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="product-info">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box border">
                                                    <img src="{{ asset('assets2/images/products/10.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="product-info">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-box border">
                                                    <img src="{{ asset('assets2/images/products/12.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="product-info">
    ...
    <script src="{{ asset('assets2/plugins/apexcharts-bundle/js/apexcharts.min.js') }}"></script>
    <script src="{{ asset('assets2/plugins/chartjs/chart.min.js') }}"></script>
