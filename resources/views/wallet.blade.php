        ...
        <div class="container">
            <div class="row mt-5 d-flex justify-content-center   ">
                    ...
                    <div class="col-12 col-md-4 col-sm-6 mb-3">
                        <div class="card_wideaget p-3 rounded-3 d-flex align-items-center justify-content-center">
                            <div class="d-flex flex-column">
                                ...
                                <div class="text-center fs-6 fw-bold text-capitalize"> All second users </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4 col-sm-6 mb-3">
                        <div class="card_wideaget p-3 rounded-3 d-flex align-items-center justify-content-center">
                            <div class="d-flex flex-column">
                                ...
                                <div class="text-center fs-6 fw-bold text-capitalize"> All first users </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div action="{{ route('wallet.save') }}" method="POST" class="balance-card">
                        @csrf
        ...
        <div class="modal-dialog d-flex justify-content-center">
            <div class="modal-content" style="width: 500px; height: 400px; overflow: hidden;">
                ...
                <div class="modal-body">
                    <form id="withdrawalForm" action="{{ route('wallet.update') }}" method="POST">
                        @csrf
